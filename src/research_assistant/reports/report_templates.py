...
class ReportTemplateManager:
    ...
    def __init__(self, templates_dir: Optional[str] = None):
        ...
        self.logger = get_logger("report_templates")

    def load_templates(self) -> None:
        """Load all report templates from the templates directory."""
        try:
    ...
    def _load_template_file(self, template_file: Path) -> None:
        ...
        try:
            ...
            for template_name, template_info in template_data.items():
                ...
                self.templates[template_name] = self.env.from_string(template_str)
    ...
    def get_template_info(self, template_name: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            "name": template_name,
            "variables": list(template.module.__annotations__.keys()),
            "description": getattr(template.module, "__doc__", ""),
            "format": getattr(template.module, "format", "markdown")
        } 